    ...
    @endif
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="/admin/2010_2011/delete" method="POST">
                @csrf
                @method("DELETE")
                <input type="hidden" name="songid" id="songid" value="{{ $songs2010->_id }}">
                    <div class="form-group">
                        <label for="song_title">Song title</label>
                        <input type="text" class="form-control" id="song_title" name="song_title" value="{{ $songs2010->title}}" disabled>
                    </div>
                    <div class="form-group">
                    <label for ="artist"> Artists </label>
                    <textarea class= "form-control" name="artist" id="artist" cols="30" rows="3" value="{{ $songs2010->artist}}" disabled></textarea>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" class="form-control" id="year" name="year" value="{{ $songs2010->year}} disabled">
